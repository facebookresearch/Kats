...
from ..consts import DEFAULT_TIME_NAME, DEFAULT_VALUE_NAME, TimeSeriesData, TSIterator


# Constant values to reuse across test cases
DATA_FILE = "infrastrategy/kats/data/air_passengers.csv"
TIME_COL_NAME = "ds"
VALUE_COL_NAME = "y"
...
class TimeSeriesDataInitTest(testutil.BaseFacebookTestCase):
    ...
    def test_init_from_df_univar(self):
    ...
    def test_init_from_df_multi(self):
    ...
    def test_init_from_series_univar(self):
    ...
    def test_init_from_series_multivar(self):
    ...
    # pd.DateTimeIndex
    def test_init_from_index_univar(self):
        assert_series_equal(
    ...
    # pd.DateTimeIndex
    def test_init_from_index_multivar(self):
        assert_series_equal(
    ...
    def test_incorrect_init_types(self):
    ...
    def test_infer_freq_robust(self):
        self.assertEqual(

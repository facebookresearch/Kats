...
class NeuralProphetParams(Params):
    ...
    Attributes:
       ...
       ## AR Parameters
          ...
          ar_reg (float): [0-100], how much sparsity to enduce in the AR-coefficients.
      ...
      ## Train Parameters
          ...
          newer_samples_weight (float): Sets factor by which the model fit is skewed towards more recent observations.
          ...
          newe_samples_start (float): Sets beginning of 'newer' samples as fraction of training data.
